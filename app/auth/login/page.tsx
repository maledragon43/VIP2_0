      ...
      <div className="max-w-md w-full">
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Sign in to continue connecting</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="rounded border-gray-300 text-vip-600 shadow-sm focus:border-vip-300 focus:ring focus:ring-vip-200 focus:ring-opacity-50"
                />
                <span className="ml-2 text-sm text-gray-600">Remember me</span>
              </label>
              <Link href="/auth/forgot-password" className="text-sm text-vip-600 hover:text-vip-700">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/auth/signup" className="text-vip-600 hover:text-vip-700 font-medium">
                Sign up
              </Link>
            </p>
          </div>
